...
const {uploadUserPhoto, uploadEventPhoto, uploadAthleticPhoto, uploadUserRegistration} = require('../controllers/uploadController.js')

router.post('/photouser', authMiddleware, uploadUserPhoto)
router.post('/photouserregister', authMiddleware, uploadUserRegistration)
