    ...
    return queryInterface.bulkInsert('Events', [
      {
        ...
        description: "O carnaval é uma festa popular que ocorre anualmente em diversos países ao redor do mundo.",
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        policy: "Você aceita os termos?",
        description: "A Expoacre é uma feira agropecuária e industrial que acontece todos os anos no estado do Acre, no Brasil.",
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        location: "-10.01806,-67.79816",
        policy: "Você aceita os termos?",
        description: "Os Jogos Universitários são competições esportivas realizadas entre instituições de ensino superior, como universidades e faculdades.",
        createdAt: new Date(),
        updatedAt: new Date(),
      }
      // {
